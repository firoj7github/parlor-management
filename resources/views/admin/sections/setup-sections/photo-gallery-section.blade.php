...
@section('breadcrumb')
    ...
    ], 'active' => __("Photo Gallery Section")])
@endsection
...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#photo-gallery-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Image") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.photo-gallery-section.add')
    @include('admin.components.modals.site-section.photo-gallery-section.edit')
@endsection
@push('script')
<script>
        
    openModalWhenError("photo-gallery-add","#photo-gallery-add");
    openModalWhenError("photo-gallery-edit","#photo-gallery-edit");
    ...
    $('.edit-modal-button').click(function(){
        ...
        var editModal = $("#photo-gallery-edit");

        editModal.find("form").first().find("input[name=target]").val(oldData.id);
        editModal.find("input[name=image]").attr("data-preview-name",oldData.image);
        fileHolderPreviewReInit("#photo-gallery-edit input[name=image]");
        openModalBySelector("#photo-gallery-edit");
    });
